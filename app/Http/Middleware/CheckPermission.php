...
class CheckPermission
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        if (auth('api')->check()) {
            ...
            $skipResourcePath = ['call_managers', 'leads', 'documents','smsMessages', 'sales', 'users','debt_notes', 'debts', 'sms_templates','lead_statuses','sale_statuses', 'individual_logs', 'individuals', 'lead_follow_ups', 'salesman_bookings', 'permissions'];
